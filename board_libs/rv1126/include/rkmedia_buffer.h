...
_CAPI void *RK_MPI_MB_GetRawPtr(MEDIA_BUFFER mb);
_CAPI void *RK_MPI_MB_GetPtr(MEDIA_BUFFER mb);
_CAPI int RK_MPI_MB_GetFD(MEDIA_BUFFER mb);
_CAPI size_t RK_MPI_MB_GetRawPtrSize(MEDIA_BUFFER mb);
...
_CAPI MEDIA_BUFFER RK_MPI_MB_CreateAudioBuffer(RK_U32 u32BufferSize,
                                               RK_BOOL boolHardWare);
_CAPI MEDIA_BUFFER RK_MPI_MB_CreateAudioRawBuffer(RK_U32 u32BufferSize,
                                         RK_U32 u32RawBufferSize,
                                         RK_BOOL boolHardWare);
